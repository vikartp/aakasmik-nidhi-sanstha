...
export const PortalGrid: React.FC<PortalGridProps> = ({
  ...
  if (activeFeature && activeFeatureData) {
    return (
      <div className="w-full max-w-7xl mx-auto animate-fade-in-up border border-blue-200/50 dark:border-blue-900/50 bg-white/40 dark:bg-zinc-950/40 rounded-2xl p-4 sm:p-6 mb-6 shadow-sm backdrop-blur-sm">
        <div className="flex items-center mb-6 gap-4 border-b border-gray-200 dark:border-gray-800 pb-4">
          <Button
            variant="ghost"
            className="flex items-center gap-1.5 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors rounded-full px-3 py-2 h-auto"
        ...
        <div className="bg-white/60 dark:bg-black/40 backdrop-blur-md rounded-xl border border-gray-200/80 dark:border-gray-800/80 p-4 sm:p-6 shadow-sm">
          {children}
        </div>
      </div>
    );
